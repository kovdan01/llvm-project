...
# RUN:   FileCheck --check-prefix ELF-TAG -DPLATFORM=0x2a -DVERSION=0x1 %s
# RUN: llvm-readobj --notes tag-42-1.o | \
# RUN:   FileCheck --check-prefix OBJ-TAG -DPLATFORM=42   -DVERSION=1   %s
...
# RUN:   FileCheck --check-prefix OBJ-TAG -DPLATFORM=0               -DVERSION=0   %s
...
# RUN:   FileCheck --check-prefix OBJ-TAG -DPLATFORM=1                 -DVERSION=0   %s
...
# RUN: llvm-readelf --notes tag-2-21.o | \
# RUN:   FileCheck --check-prefix ELF-TAG -DPLATFORM="0x2 (linux)" \
# RUN:   -DVERSION="0x15 (PointerAuthCalls, !PointerAuthReturns, PointerAuthVTPtrAddressDiscrimination, !PointerAuthVTPtrTypeDiscrimination, PointerAuthInitFini)" %s
# RUN: llvm-readobj --notes tag-2-21.o | \
# RUN:   FileCheck --check-prefix OBJ-TAG -DPLATFORM=2 -DVERSION=21 %s
...
# RUN:   FileCheck --check-prefix=ELF-GNU -DPLATFORM=0x2a -DVERSION=0x1 %s
# RUN: llvm-readobj --notes gnu-42-1.o | \
# RUN:   FileCheck --check-prefix=OBJ-GNU -DPLATFORM=0x2a -DVERSION=0x1 %s
...
# RUN: llvm-readelf --notes gnu-2-21.o | \
# RUN:   FileCheck --check-prefix=ELF-GNU -DPLATFORM="0x2 (linux)" \
# RUN:   -DVERSION="0x15 (PointerAuthCalls, !PointerAuthReturns, PointerAuthVTPtrAddressDiscrimination, !PointerAuthVTPtrTypeDiscrimination, PointerAuthInitFini)" %s
# RUN: llvm-readobj --notes gnu-2-21.o | \
# RUN:   FileCheck --check-prefix=OBJ-GNU -DPLATFORM="0x2 (linux)" \
# RUN:   -DVERSION="0x15 (PointerAuthCalls, !PointerAuthReturns, PointerAuthVTPtrAddressDiscrimination, !PointerAuthVTPtrTypeDiscrimination, PointerAuthInitFini)" %s
