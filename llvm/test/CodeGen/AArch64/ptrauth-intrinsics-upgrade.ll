...
; CHECK-NEXT:    [[ZERO_DISCR:%.*]] = call i64 @llvm.ptrauth.sign(i64 [[P:%.*]]) [ "ptrauth"(i32 1, i64 0) ]
; CHECK-NEXT:    [[IMM_DISCR:%.*]] = call i64 @llvm.ptrauth.sign(i64 [[P]]) [ "ptrauth"(i32 1, i64 42) ]
; CHECK-NEXT:    [[ADDR_DISCR:%.*]] = call i64 @llvm.ptrauth.sign(i64 [[P]]) [ "ptrauth"(i32 1, i64 [[ADDR:%.*]]) ]
; CHECK-NEXT:    [[BLENDED_DISCR:%.*]] = call i64 @llvm.ptrauth.sign(i64 [[P]]) [ "ptrauth"(i32 1, i64 [[ADDR]], i64 1234) ]
; CHECK-NEXT:    ret void
;
...
; CHECK-NEXT:    [[ZERO_DISCR:%.*]] = call i64 @llvm.ptrauth.auth(i64 [[P:%.*]]) [ "ptrauth"(i32 1, i64 0) ]
; CHECK-NEXT:    [[IMM_DISCR:%.*]] = call i64 @llvm.ptrauth.auth(i64 [[P]]) [ "ptrauth"(i32 1, i64 42) ]
; CHECK-NEXT:    [[ADDR_DISCR:%.*]] = call i64 @llvm.ptrauth.auth(i64 [[P]]) [ "ptrauth"(i32 1, i64 [[ADDR:%.*]]) ]
; CHECK-NEXT:    [[BLENDED_DISCR:%.*]] = call i64 @llvm.ptrauth.auth(i64 [[P]]) [ "ptrauth"(i32 1, i64 [[ADDR]], i64 1234) ]
; CHECK-NEXT:    ret void
;
  %tmp = call i64 @llvm.ptrauth.blend(i64 %addr, i64 1234)
...
; CHECK-NEXT:    [[IMM_IMM_DISCR:%.*]] = call i64 @llvm.ptrauth.resign(i64 [[P:%.*]]) [ "ptrauth"(i32 1, i64 42), "ptrauth"(i32 2, i64 123) ]
; CHECK-NEXT:    [[ZERO_IMM_DISCR:%.*]] = call i64 @llvm.ptrauth.resign(i64 [[P]]) [ "ptrauth"(i32 1, i64 0), "ptrauth"(i32 2, i64 123) ]
; CHECK-NEXT:    [[ADDR_IMM_DISCR:%.*]] = call i64 @llvm.ptrauth.resign(i64 [[P]]) [ "ptrauth"(i32 1, i64 [[ADDR:%.*]]), "ptrauth"(i32 2, i64 123) ]
; CHECK-NEXT:    [[BLENDED_IMM_DISCR:%.*]] = call i64 @llvm.ptrauth.resign(i64 [[P]]) [ "ptrauth"(i32 1, i64 [[ADDR]], i64 1234), "ptrauth"(i32 2, i64 123) ]
; CHECK-NEXT:    [[IMM_ZERO_DISCR:%.*]] = call i64 @llvm.ptrauth.resign(i64 [[P]]) [ "ptrauth"(i32 1, i64 123), "ptrauth"(i32 2, i64 0) ]
; CHECK-NEXT:    [[IMM_ADDR_DISCR:%.*]] = call i64 @llvm.ptrauth.resign(i64 [[P]]) [ "ptrauth"(i32 1, i64 123), "ptrauth"(i32 2, i64 [[ADDR]]) ]
; CHECK-NEXT:    [[IMM_BLENDED_DISCR:%.*]] = call i64 @llvm.ptrauth.resign(i64 [[P]]) [ "ptrauth"(i32 1, i64 123), "ptrauth"(i32 2, i64 [[ADDR]], i64 5678) ]
; CHECK-NEXT:    [[ZERO_BLENDED_DISCR:%.*]] = call i64 @llvm.ptrauth.resign(i64 [[P]]) [ "ptrauth"(i32 1, i64 0), "ptrauth"(i32 2, i64 [[ADDR]], i64 4321) ]
; CHECK-NEXT:    [[ADDR_BLENDED_DISCR:%.*]] = call i64 @llvm.ptrauth.resign(i64 [[P]]) [ "ptrauth"(i32 1, i64 [[ADDR]]), "ptrauth"(i32 2, i64 [[ADDR]], i64 4321) ]
; CHECK-NEXT:    [[BLENDED_ZERO_DISCR:%.*]] = call i64 @llvm.ptrauth.resign(i64 [[P]]) [ "ptrauth"(i32 1, i64 [[ADDR]], i64 8765), "ptrauth"(i32 2, i64 0) ]
; CHECK-NEXT:    [[BLENDED_ADDR_DISCR:%.*]] = call i64 @llvm.ptrauth.resign(i64 [[P]]) [ "ptrauth"(i32 1, i64 [[ADDR]], i64 8765), "ptrauth"(i32 2, i64 [[ADDR]]) ]
; CHECK-NEXT:    [[BLENDED_BLENDED_DISCR:%.*]] = call i64 @llvm.ptrauth.resign(i64 [[P]]) [ "ptrauth"(i32 1, i64 [[ADDR]], i64 111), "ptrauth"(i32 2, i64 [[ADDR]], i64 222) ]
; CHECK-NEXT:    ret void
;
...
; CHECK-NEXT:    [[RES:%.*]] = call i64 @llvm.ptrauth.strip(i64 [[P:%.*]]) [ "ptrauth"(i32 1) ]
; CHECK-NEXT:    ret void
;
...
; CHECK-NEXT:    [[RES1:%.*]] = call i64 @llvm.ptrauth.auth(i64 [[P1:%.*]]) [ "ptrauth"(i32 1, i64 [[ADDR:%.*]], i64 1234) ]
; CHECK-NEXT:    [[RES2:%.*]] = call i64 @llvm.ptrauth.auth(i64 [[P2:%.*]]) [ "ptrauth"(i32 2, i64 [[ADDR]], i64 1234) ]
; CHECK-NEXT:    ret void
;
  %tmp = call i64 @llvm.ptrauth.blend(i64 %addr, i64 1234)
...
; CHECK-NEXT:    [[RES:%.*]] = call i64 @llvm.ptrauth.resign(i64 [[P:%.*]]) [ "ptrauth"(i32 1, i64 [[ADDR:%.*]], i64 1234), "ptrauth"(i32 2, i64 [[ADDR]], i64 1234) ]
; CHECK-NEXT:    ret void
;
  %tmp = call i64 @llvm.ptrauth.blend(i64 %addr, i64 1234)
