...
public:
  ...
  bool isSymbolicUImm12Offset(const MCExpr *Expr) const {
    ...
    if (DarwinRefKind == MCSymbolRefExpr::VK_PAGEOFF ||
        ...
        ELFRefKind == AArch64MCExpr::VK_GOTAUTH_LO12 ||
        ...
        ELFRefKind == AArch64MCExpr::VK_GOTAUTH_PAGE_LO15) {
  ...
  if (classifySymbolRef(Expr, ELFRefKind, DarwinRefKind, Addend)) {
    if (DarwinRefKind == MCSymbolRefExpr::VK_None &&
      ...
      return Error(S, "gotpage label reference not allowed an addend");
               ...
               ELFRefKind != AArch64MCExpr::VK_GOTAUTH_PAGE &&
               ELFRefKind != AArch64MCExpr::VK_GOT_PAGE_LO15 &&
               ELFRefKind != AArch64MCExpr::VK_GOTAUTH_PAGE_LO15 &&
  ...
  if (parseOptionalToken(AsmToken::Colon)) {
    ...
    RefKind =
        StringSwitch<AArch64MCExpr::VariantKind>(LowerCase)
            ...
            .Case("got_auth", AArch64MCExpr::VK_GOTAUTH_PAGE)
            .Case("gotpage_auth_lo15", AArch64MCExpr::VK_GOTAUTH_PAGE_LO15)
            .Case("got_auth_lo12", AArch64MCExpr::VK_GOTAUTH_LO12)
