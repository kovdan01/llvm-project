...
C *exact_to_C(A *a) {
  ...
  // CHECK: [[AUTHED_VPTRI:%.*]] = tail call i64 @llvm.ptrauth.auth(i64 [[UNAUTHED_VPTRI]]) [ "ptrauth"(i64 2, i64 [[VPTR_ADDRI]], i64 62866) ]
...
D *exact_t_D(A *a) {
  ...
  // CHECK:   [[SRC_AUTHED_VPTRI:%.*]] = tail call i64 @llvm.ptrauth.auth(i64 [[SRC_UNAUTHED_VPTRI]]) [ "ptrauth"(i64 2, i64 [[SRC_VPTR_ADDRI]], i64 62866) ]
  ...
  // CHECK:   [[ADJUSTED_AUTHED_VPTRI:%.*]] = tail call i64 @llvm.ptrauth.auth(i64 [[ADJUSTED_UNAUTHED_VPTRI]]) [ "ptrauth"(i64 2, i64 [[ADJUSTED_VPTR_ADDRI]], i64 28965) ]
...
L *exact_multi(E *e) {
  ...
  // CHECK:   [[AUTHED_VTABLEI:%.*]] = tail call i64 @llvm.ptrauth.auth(i64 [[VTABLE_ADDRI]]) [ "ptrauth"(i64 2, i64 [[THIS_ADDRI]], i64 12810) ]
  ...
  // CHECK:   tail call i64 @llvm.ptrauth.auth(i64 [[ADJUSTED_THIS_VTABLEI]]) [ "ptrauth"(i64 2, i64 [[ADJUSTED_THISI]], i64 41434) ]
  // CHECK:   br label %dynamic_cast.postauth.complete
  // CHECK: dynamic_cast.postauth.complete:
  // CHECK:   [[AUTHED_ADJUSTED_THIS:%.*]] = phi ptr [ [[ADJUSTED_THIS]], %dynamic_cast.postauth.success ], [ null, %dynamic_cast.notnull ]
  // CHECK:   br i1 [[SUCCESS]], label %dynamic_cast.end, label %dynamic_cast.null
