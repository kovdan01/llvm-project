...
// CHECK: [[RESULT:%.*]] = call i64 @llvm.ptrauth.auth(i64 [[LOAD]]) [ "ptrauth"(i64 1, i64 [[CAST_ADDR]], i64 1) ]

// CHECK-LABEL: define internal void @"\01-[Root setField1:]"
// CHECK: [[CAST_ADDR:%.*]] = ptrtoint ptr [[ADDR:%.*]] to i64
// CHECK: [[RESULT:%.*]] = call i64 @llvm.ptrauth.sign(i64 [[VALUE:%.*]]) [ "ptrauth"(i64 1, i64 [[CAST_ADDR]], i64 1) ]
...
// CHECK: [[RESULT:%.*]] = call i64 @llvm.ptrauth.auth(i64 [[VALUE]]) [ "ptrauth"(i64 1, i64 [[CAST_ADDR:%.*]], i64 1) ]

// CHECK-LABEL: define internal void @"\01-[Root setField2:]"
// CHECK: [[CAST_ADDR:%.*]] = ptrtoint ptr [[ADDR:%.*]] to i64
// CHECK: [[CAST_VALUE:%.*]] = ptrtoint ptr [[VALUE:%.*]] to i64
// CHECK: [[SIGNED:%.*]] = call i64 @llvm.ptrauth.sign(i64 [[CAST_VALUE]]) [ "ptrauth"(i64 1, i64 [[CAST_ADDR]], i64 1) ]
...
// CHECK: {{%.*}} = call i64 @llvm.ptrauth.resign(i64 [[VALUE]]) [ "ptrauth"(i64 1, i64 [[CASTED_ADDR]], i64 1), "ptrauth"(i64 0, i64 0) ]

// CHECK-LABEL: define internal void @"\01-[Root setField3:]"
// CHECK: [[VALUE:%.*]] = load i64, ptr {{%.*}}, align 8
// CHECK: [[CASTED_ADDR:%.*]] = ptrtoint ptr {{%.*}} to i64
// CHECK: {{%.*}} = call i64 @llvm.ptrauth.resign(i64 [[VALUE]]) [ "ptrauth"(i64 0, i64 0), "ptrauth"(i64 1, i64 [[CASTED_ADDR]], i64 1) ]
...
// CHECK: [[CASTED_ADDR:%.*]] = ptrtoint ptr [[ADDR]] to i64
// CHECK: [[CAST_VALUE:%.*]] = ptrtoint ptr [[VALUE]] to i64
// CHECK: {{%.*}} = call i64 @llvm.ptrauth.resign(i64 [[CAST_VALUE]]) [ "ptrauth"(i64 1, i64 [[CASTED_ADDR]], i64 123), "ptrauth"(i64 0, i64 0) ]
...
// CHECK: {{%.*}} = call i64 @llvm.ptrauth.resign(i64 [[VALUE]]) [ "ptrauth"(i64 0, i64 0), "ptrauth"(i64 1, i64 [[CAST_ADDR]], i64 123) ]
